const ButtonLink = ({ href, children, ext }) => {
  return (
    <a
      href={href}
      target={ext ? "_blank" : ""}
      className="uppercase border border-solid border-title-clr px-3 py-1 rounded-md bg-transparent transition-colors relative z-10 duration-500 overflow-hidden cursor-pointer text-title-clr flex gap-2 items-center
